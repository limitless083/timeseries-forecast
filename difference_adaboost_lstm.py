...
if __name__ == '__main__':
    ...
    series = pandas.read_csv('./data/wolfs-sunspot-numbers-1700-1988.csv', usecols=[1], engine='python')
    raw_values = series.values
    raw_values = raw_values.astype('float32')
    t0 = raw_values[0]
    # plt.plot(raw_values, 'k-', linewidth=1.0)
    # plt.show()
    ...
    adaboost_rounds = 3
    for i in range(adaboost_rounds):
